...
#contact {
  ...
  .pad-text{ margin: 0% 50% 0 40%;padding-top:40px; font-size: 30px;}
    .pad-text2{ float:right;padding-top:40px; font-size: 30px;}

</style>
<div class="fixed-pos">
<div id="mySidenav" class="sidenav">
  <a href="../admin/login.php" id="about"><div class="pad-img"><img src="img/settings.png" style="float:left;width:80px;"></div><div class="pad-text">ADMIN</div> </a>
</div>
</div>